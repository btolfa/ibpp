...
ExceptionBase::ExceptionBase(const ExceptionBase& copied)
{
	mContext = copied.mContext;
	mWhat = copied.mWhat;
}

ExceptionBase& ExceptionBase::operator=(const ExceptionBase& copied)
{
	if (&copied != this)
	{
		mContext = copied.mContext;
...
ExceptionBase::ExceptionBase(const std::string& context, const char* message, ...)
{
	va_list argptr;
...
const char* ExceptionBase::Origin() const
{
	return mContext.c_str();
}

const char* ExceptionBase::ErrorMessage() const
{
	return mWhat.c_str();
}
...
LogicExceptionImpl::LogicExceptionImpl(const LogicExceptionImpl& copied)
	: IBPP::LogicException(), ExceptionBase(copied)
{
}

//lint -e{1539} members are copied through call to baseclass operator=
LogicExceptionImpl& LogicExceptionImpl::operator=(const LogicExceptionImpl& copied)
{
	if (&copied != this)
...
const char* LogicExceptionImpl::Origin() const
{
	return ExceptionBase::Origin();
}

const char* LogicExceptionImpl::ErrorMessage() const
{
...
SQLExceptionImpl::SQLExceptionImpl(const SQLExceptionImpl& copied)
...
//lint -e{1539} members are copied through call to baseclass operator=
SQLExceptionImpl& SQLExceptionImpl::operator=(const SQLExceptionImpl& copied)
{
	if (&copied != this)
	{
		ExceptionBase::operator=(copied);
...
const char* SQLExceptionImpl::Origin() const
{
	return ExceptionBase::Origin();
}

const char* SQLExceptionImpl::ErrorMessage() const
{
	return ExceptionBase::what();
}
...
int SQLExceptionImpl::SqlCode() const
{
	return mSqlCode;
}

int SQLExceptionImpl::EngineCode() const
{
	return mEngineCode;
}
...
WrongTypeImpl::WrongTypeImpl(const WrongTypeImpl& copied)
	: IBPP::WrongType(), ExceptionBase(copied)
{
}

//lint -e{1539} members are copied through call to baseclass operator=
WrongTypeImpl& WrongTypeImpl::operator=(const WrongTypeImpl& copied)
{
	if (&copied != this)
		ExceptionBase::operator=(copied);
	return *this;
...
const char* WrongTypeImpl::Origin() const
{
	return ExceptionBase::Origin();
}

const char* WrongTypeImpl::ErrorMessage() const
{
	return ExceptionBase::what();
}
